...
## Datasets
The relevant datasets are made publicly available and can be found in one of our [recent research efforts](https://github.com/LiuAoyu1998/STIDGCN)recent research efforts accepted by the IEEE Transactions on Intelligent Transportation Systems.
